  ...
  return (
    <>
      ...
      <Typography variant="body1" color="palette.text.primary">
        ...
        quibusdam assumenda repellat rem? Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Dignissimos soluta error, magnam assumenda reiciendis,
        animi rem sed voluptatibus hic, asperiores placeat corporis harum!
        Quaerat illum labore impedit temporibus aliquam accusamus! Lorem ipsum,
        dolor sit amet consectetur adipisicing elit. Ipsa porro animi provident
        veritatis architecto aliquid alias aspernatur facere soluta voluptatum
        nihil ea quia iusto repellendus corrupti, eius doloribus? Tempora,
        repudiandae! Lorem ipsum, dolor sit amet consectetur adipisicing elit.
        Iure ratione aspernatur, laborum veritatis, sed, quis ducimus quidem
        magni ab cupiditate iste perspiciatis exercitationem? Quia laboriosam
        recusandae eum ut earum pariatur!
      </Typography>
      <Typography variant="body1" color="palette.text.primary">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Non itaque
        voluptatum labore iusto tempore ut quam enim, totam ad nesciunt porro
